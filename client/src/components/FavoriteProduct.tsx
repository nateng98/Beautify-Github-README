        ...
        <div className='lg:flex-1'>
          <div className='sm:flex'>
            ...
            <span
              ...
              className='text-lg text-gray-600 hover:text-red-700 duration-200 cursor-pointer inline-block mt-4 sm:mt-0'
            >
              <MdClose />
            </span>
          </div>
          <div className='flex text-sm items-center gap-6 font-medium py-4'>
            <AddToCartBtn product={product} className='w-32 bg-darkText hover:bg-red-700 text-whiteText' />
          </div>
        </div>
        <p>
          You are saving{' '}
