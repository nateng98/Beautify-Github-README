...
import { MdOutlineProductionQuantityLimits, MdOutlineShoppingBag } from 'react-icons/md';
        ...
        <main className='px-6 pb-16 pt-10 sm:pb-24 lg:px-8'>
          <div className='text-center'>
            ...
            <h1 className='mt-2 text-3xl font-bold tracking-tight text-darkText'>
              <span className='text-red-700 underline underline-offset-2 decoration-[1px] capitalize'>
                {path}
              </span>{' '}
              does not exist
            </h1>
